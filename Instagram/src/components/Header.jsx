...
const Header = () =>{
  ...
  return  <header className="p-3 header"> 
            <div className="container"> 
              <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start"> 
                ...
                <div className="text-end"> 
                  <button type="button" id="login" className="btn btn-outline-light me-2">Login</button> 
                  <button type="button" id="signUp" className="btn ">Sign-up</button> 
                </div> 
              </div> 
            </div> 
          </header>
